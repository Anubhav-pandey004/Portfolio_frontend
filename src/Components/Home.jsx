    ...
    <main className="h-[100vh] w-[100vw] bg-black overflow-hidden">
      {!loader && (
        <>
          ...
          <div
            ref={slider}
            className="loading-window fixed top-0 left-[-100vw] w-[100vw] h-[100vh] md:pb-0 pb-12 md:h-[100vh] overflow-auto bg-[#dddf00] z-0 flex flex-col justify-center items-center"
          ></div>
        </>
      )}
      {loader && <Dashboard />}
