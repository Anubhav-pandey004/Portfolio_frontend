...
const WarpRealityButton = ({ mainpage , slider , setShowParticles , setloader }) => {
  ...
  return (
    ...
    >
      ...
      <section ref={loadingPercentage} className="w-full flex justify-end items-end  text-white mix-blend-difference font-bold md:text-7xl text-5xl md:mb-0 mb-14  z-60 font-mono"
      style={{
